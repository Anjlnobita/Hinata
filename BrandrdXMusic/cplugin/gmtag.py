...
@Client.on_message(filters.command(["gntag", "tagmember" ], prefixes=["/", "@", "#"]))
...
@Client.on_message(filters.command(["gmtag"], prefixes=["/", "@", "#"]))
...
@Client.on_message(filters.command(["gmstop", "gnstop", "cancle"]))
